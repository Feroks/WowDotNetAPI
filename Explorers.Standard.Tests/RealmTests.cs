...
namespace WowDotNetAPI.Explorers.Test
{
    ...
    public class RealmTests
    {
        ...
        {
            var realmList = _explorer.Realm.GetRealms();
        ...
        {
            var realm = _explorer.Realm.GetRealms().FirstOrDefault(r => r.Name.Equals("skullcrusher", StringComparison.OrdinalIgnoreCase));
        ...
        {
            var realms = _explorer.Realm.GetRealms().Where(r => r.Type == RealmType.PVP).ToList();
        ...
        {
            var realmList = _explorer.Realm.GetRealms().Where(r => r.Status).ToList();
        ...
        {
            var realmList = _explorer.Realm.GetRealms().Where(r => r.Queue == false).ToList();
        ...
        {
            var realmList = _explorer.Realm.GetRealms().Where(r => r.Population == "low").ToList();
